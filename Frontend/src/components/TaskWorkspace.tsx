...
export function TaskWorkspace(props: TaskWorkspaceProps) {
  ...
  return (
    <div className="p-5 sm:p-8 lg:min-h-0 lg:flex-1 lg:overscroll-contain lg:overflow-y-auto lg:p-10">
      ...
      <TaskList tasks={tasks} loading={loading} onSave={onSave} onDelete={onDelete} onAttach={onAttach} onDeleteAttachment={onDeleteAttachment} onViewAttachment={onViewAttachment} onSetReminder={onSetReminder} />
    </div>
  )
}

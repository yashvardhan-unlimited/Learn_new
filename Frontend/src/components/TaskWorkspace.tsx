...
export function TaskWorkspace(props: TaskWorkspaceProps) {
  const { tasks, loading, error, onCreate, onSave, onDelete, onAttach, onDeleteAttachment, onDownloadAttachment, onSetReminder } = props
  return (
    <div className="p-5 sm:p-8 lg:min-h-0 lg:flex-1 lg:overscroll-contain lg:overflow-y-auto lg:p-10">
      ...
      <TaskList tasks={tasks} loading={loading} onSave={onSave} onDelete={onDelete} onAttach={onAttach} onDeleteAttachment={onDeleteAttachment} onDownloadAttachment={onDownloadAttachment} onSetReminder={onSetReminder} />
    </div>
  )
}

...
export function TaskToolbar({ sort, totalTasks, viewMode, onViewChange, onCreate }: Props) {
  return (
    <div className="mb-7 rounded-2xl border border-white/70 bg-white/65 p-3 shadow-[0_12px_40px_rgb(79_70_229/0.08)] backdrop-blur-xl sm:p-4">
      <div className="flex flex-wrap items-center gap-3">
        <div className="flex rounded-xl border border-slate-200/80 bg-slate-100/70 p-1" role="group" aria-label="Task view">
